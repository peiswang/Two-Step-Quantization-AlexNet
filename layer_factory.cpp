...
// Get relu2b layer.
template <typename Dtype>
shared_ptr<Layer<Dtype> > GetReLU2BLayer(const LayerParameter& param) {
    return shared_ptr<Layer<Dtype> >(new ReLU2BLayer<Dtype>(param));
}

REGISTER_LAYER_CREATOR(ReLU2B, GetReLU2BLayer);
